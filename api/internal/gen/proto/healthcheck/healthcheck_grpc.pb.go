...
const (
	HealthCheckService_GetHeartbeat_FullMethodName = "/healthcheck.HealthCheckService/GetHeartbeat"
)
...
func (c *healthCheckServiceClient) GetHeartbeat(ctx context.Context, in *GetHeartbeatRequest, opts ...grpc.CallOption) (*GetHeartbeatResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetHeartbeatResponse)
	err := c.cc.Invoke(ctx, HealthCheckService_GetHeartbeat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHealthCheckServiceServer) GetHeartbeat(context.Context, *GetHeartbeatRequest) (*GetHeartbeatResponse, error) {
...
func _HealthCheckService_GetHeartbeat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetHeartbeatRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HealthCheckServiceServer).GetHeartbeat(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HealthCheckService_GetHeartbeat_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthCheckServiceServer).GetHeartbeat(ctx, req.(*GetHeartbeatRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _HealthCheckService_GetHeartbeat_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/healthcheck/healthcheck.proto",
}
