...
const file_proto_product_product_proto_rawDesc = "" +
	"\n" +
	"\x1bproto/product/product.proto\x12\aproduct\"\x85\x01\n" +
	"\aProduct\x12\x0e\n" +
	...
	"categories\"\x17\n" +
	"\x15GetProductListRequest\"F\n" +
	"\x16GetProductListResponse\x12,\n" +
	"\bproducts\x18\x01 \x03(\v2\x10.product.ProductR\bproducts2e\n" +
	"\x0eProductService\x12S\n" +
	"\x0eGetProductList\x12\x1e.product.GetProductListRequest\x1a\x1f.product.GetProductListResponse\"\x00B7Z5grpc_go_sample/api/internal/gen/proto/product;productb\x06proto3"
...
var file_proto_product_product_proto_goTypes = []any{
	...
	(*GetProductListRequest)(nil),  // 1: product.GetProductListRequest
	(*GetProductListResponse)(nil), // 2: product.GetProductListResponse
}
var file_proto_product_product_proto_depIdxs = []int32{
	0, // 0: product.GetProductListResponse.products:type_name -> product.Product
	1, // 1: product.ProductService.GetProductList:input_type -> product.GetProductListRequest
	2, // 2: product.ProductService.GetProductList:output_type -> product.GetProductListResponse
